...
const HeroVideo = () => {
    ...
    <video 
      ...
      autoPlay 
      muted 
      autobuffer poster="https://relatacomm.files.wordpress.com/2020/08/social-advertising-blank.png">
    <source src="https://relatacomm.files.wordpress.com/2020/08/vid_20200530_2231157291.mp4" type="video/mp4" />
    <source src="https://videos.files.wordpress.com/9k8dPvp4/vid_20200530_2231157291_fmt1.ogv" type="video/ogg" />
